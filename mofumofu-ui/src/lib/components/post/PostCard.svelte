...
<!-- 카드 전체 -->
<div
	class="dark:bg-mofu-dark-800 dark:border-mofu-dark-800 group flex h-full cursor-pointer flex-col overflow-hidden rounded-xl border transition-all duration-200 hover:-translate-y-1 hover:opacity-70 hover:shadow-xl md:min-h-[300px]"
>
