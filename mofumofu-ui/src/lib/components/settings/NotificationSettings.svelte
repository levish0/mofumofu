		...
		<div class="space-y-4 border-t border-slate-700 pt-8">
			...
			<div class="space-y-4">
				...
				<div class="flex items-center justify-between">
					...
					<input type="time" value="22:00" class="rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm" />
				</div>
				<div class="flex items-center justify-between">
					<div>
					...
					<input type="time" value="08:00" class="rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm" />
				</div>
				<div class="flex items-center justify-between">
					<div>
