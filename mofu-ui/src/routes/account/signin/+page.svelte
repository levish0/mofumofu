<div class="flex min-h-full">
	...
	<div class="relative hidden w-0 flex-1 overflow-hidden rounded-l-lg lg:block">
		<img
	...
	<div
		class="flex flex-1 flex-col justify-center  bg-mofu-dark-900 px-4 py-12 shadow-lg sm:px-6 lg:flex-none lg:px-20 xl:px-24"
	>
		<div class="mx-auto w-full max-w-sm lg:w-96">
			<div>
				...
				<p class="mt-2 text-sm/6 text-gray-500">
					아직 계정이 없으신가요?
					<a href="#" class="rounded-md font-semibold text-indigo-600 hover:text-indigo-500"
						>가입하기</a
					>
				</p>
			</div>
				...
				<div>
					<form action="#" method="POST" class="space-y-6">
						...
						<div class="flex items-center justify-between">
							...
							<div class="text-sm/6">
								<a href="#" class="rounded-md font-semibold text-indigo-600 hover:text-indigo-500">Forgot password?</a>
							</div>
						</div>
