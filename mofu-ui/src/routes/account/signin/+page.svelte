...
<div class="flex min-h-full">
  ...
  <!-- 오른쪽 로그인 폼 영역 -->
  <div
    class="bg-mofu-dark-900 flex flex-1 flex-col justify-center px-4 py-12 shadow-lg sm:px-6 lg:flex-none lg:px-20 xl:px-24 relative"
  >
    <!-- 우측 상단 테마 토글 버튼 -->
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm/6">
              <a
                ...
                class="rounded-md font-semibold text-indigo-600 hover:text-indigo-500"
                >Forgot password?</a
              >
            </div>
          </div>
