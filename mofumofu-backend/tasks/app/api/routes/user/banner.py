...
async def upload_banner(
    ...
    try:
        ...
        logger.info(
            f"배너 이미지 업로드 태스크 시작: {task.id} (user_uuid: {user_uuid}, user_handle: {user_handle}, filename: {file.filename})"
        )
...
async def delete_banner(user_uuid: str = Form(...), user_handle: str = Form(...)):
    """
    ...
    try:
        ...
        logger.info(
            f"배너 이미지 삭제 태스크 시작: {task.id} (user_uuid: {user_uuid}, user_handle: {user_handle})"
        )
...
async def update_banner(
    ...
    try:
        ...
        logger.info(
            f"배너 이미지 업데이트 태스크 시작: {task.id} (user_uuid: {user_uuid}, user_handle: {user_handle}, filename: {file.filename})"
        )
